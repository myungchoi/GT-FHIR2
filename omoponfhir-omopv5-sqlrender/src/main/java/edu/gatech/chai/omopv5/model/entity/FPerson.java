...
public class FPerson extends Person {
	public static String tableName = "f_person";

	@JsonProperty("family_name")
	private String familyName;
	
	@JsonProperty("given1_name")
	private String givenName1;
	
	@JsonProperty("given2_name")
	private String givenName2;
	
	@JsonProperty("prefix_name")
	private String prefixName;
	
	@JsonProperty("suffix_name")
	...
	@JsonProperty("contact_point1")
	String contactPoint1;
	
	@JsonProperty("contact_point2")
	String contactPoint2;
	
	@JsonProperty("contact_point3")
